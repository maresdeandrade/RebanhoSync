...
Observacao 12I: o catalogo de Protocolos Sanitarios v2 foi conectado ao offline-first Dexie em stores `catalog_*` pull-only, com `pullSanitarioProtocolCatalogV2` e leitura local read-only. Saneamento posterior corrigiu `raiva_herbivoros`, tombstonou o item antigo e deixou 21 itens ativos. Testes confirmam 10 protocolos, 21 itens, 4 grupos, B19 nacional, aftosa bloqueada e 6 antiparasitarios com ProductClassGroup. Nenhum push, `queue_ops`, agenda, evento, estoque, carencia ativa ou liberacao operacional foi criado.
