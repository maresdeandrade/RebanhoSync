...
- A Home apresenta a Central como contexto secundário dentro de um painel tático: atrasadas, agenda de hoje e ação imediata aparecem antes de leituras passivas.
- A Central Operacional passiva preserva pendências abertas, vencendo hoje, atrasadas, pendências sanitárias, rebanho por estágio, KPIs mensais e sinais operacionais auxiliares com estados `Bloqueado`, `Vazio`, `Parcial` e `Completo`, sem assumir papel de CTA ou motor de decisão.
