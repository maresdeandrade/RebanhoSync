...
- produto/lote/estoque ja possuem base estrutural tenant-scoped, contratos offline iniciais, UI operacional validada em smoke real local para entradas, ajustes e consumos, edicao de cadastros sem saldo destrutivo, estoque minimo/ponto de ressuprimento por insumo via payload, relatorio operacional com CSV/impressao e demanda futura estimada por agenda valida; a proxima pendencia e transformar ressuprimento em alerta operacional consolidado sem criar baixa automatica;
