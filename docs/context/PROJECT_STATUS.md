...
- Fase 12I — Catalogo Sanitario v2 read-only offline-first executada localmente, criando stores Dexie v27 para protocolos e itens, pull remoto `pullSanitarioProtocolCatalogV2`, leitura local Dexie e testes de store/pull/cursor/resumo; catálogo permanece pull-only e sem `queue_ops` paralelo.
